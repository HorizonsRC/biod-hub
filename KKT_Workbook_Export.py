...
def write_workbook(path, cols, rows, project_ids):
    ...
    guide = [
        ...
        ("AGOL is already filled in, so you only change what has changed or", False),
        ("needs to be added.", False),
        ("", False),
        ...
        ("", False),
        ("Adding project statistics", True),
        ("Find the project's row for its grant year and type into the green", False),
        ...
        ("blocked, because AGOL would reject it. If something needs to be", False),
